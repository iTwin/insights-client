...
import {
  Collection,
  getEntityCollectionPage,
} from "../../common/iterators/IteratorUtil";
...
} from "../interfaces/CalculatedProperties";
import type {
  CustomCalculation,
...
} from "../interfaces/CustomCalculations";
import {
  DataType,
  ECProperty,
  GroupProperty,
  ...
  GroupPropertySingle,
  GroupPropertyUpdate,
} from "../interfaces/GroupProperties";
import type {
  Group,
  GroupCollection,
  GroupCreate,
...
export class MappingsClient extends OperationsBase implements IMappingsClient {
  ...
  public getMappingsIterator(
    ...
    let url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      iModelId
    )}/mappings`;
    url += top ? `/?$top=${top}` : "";
    const request = this.createRequest("GET", accessToken);
    return new EntityListIteratorImpl(async () =>
      getEntityCollectionPage<Mapping>(
        url,
        async (nextUrl: string): Promise<Collection<Mapping>> => {
          const response: MappingCollection =
            await this.fetchJSON<MappingCollection>(nextUrl, request);
          return {
  ...
  public async getMapping(
    ...
    const url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      iModelId
  ...
  public async updateMapping(
    ...
    if (
      ...
      mapping.extractionEnabled == null &&
    ...
    if (
      mapping.mappingName != null &&
      !this.isSimpleIdentifier(mapping.mappingName)
    ) {
      throw new RequiredError(
        "mappingName",
  ...
  public async copyMapping(
    ...
    if (
      null != mappingCopy.mappingName &&
      !this.isSimpleIdentifier(mappingCopy.mappingName)
    ) {
      throw new RequiredError("mappingName", "Field mappingName was invalid.");
    }
    ...
    const url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      iModelId
    )}/mappings/${encodeURIComponent(mappingId)}/copy`;
    const requestOptions: RequestInit = this.createRequest(
      "POST",
      accessToken,
      JSON.stringify(mappingCopy)
    );
    return (await this.fetchJSON<MappingSingle>(url, requestOptions)).mapping;
  }
  ...
  public async getGroups(
    ...
    const groupIterator = this.getGroupsIterator(
      accessToken,
      iModelId,
      mappingId,
      top
  ...
  public getGroupsIterator(
    ...
    let url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      iModelId
    )}/mappings/${encodeURIComponent(mappingId)}/groups`;
    url += top ? `/?$top=${top}` : "";
    const request = this.createRequest("GET", accessToken);
    return new EntityListIteratorImpl(async () =>
      getEntityCollectionPage<Group>(
        url,
        async (nextUrl: string): Promise<Collection<Group>> => {
          const response: GroupCollection =
            await this.fetchJSON<GroupCollection>(nextUrl, request);
          return {
  ...
  public async getGroup(
    ...
    const url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      iModelId
    )}/mappings/${encodeURIComponent(mappingId)}/groups/${encodeURIComponent(
      groupId
    )}`;
    const requestOptions: RequestInit = this.createRequest("GET", accessToken);
    return (await this.fetchJSON<GroupSingle>(url, requestOptions)).group;
  ...
  public async updateGroup(
    ...
    if (
      null == group.groupName &&
      null == group.description &&
      null == group.query
    ) {
      throw new RequiredError("group", "All properties of group were missing.");
    }
    if (null != group.groupName && !this.isSimpleIdentifier(group.groupName)) {
      throw new RequiredError("groupName", "Field groupName was invalid.");
    }
  ...
  public async getGroupProperties(
    ...
    const groupPropertyIterator = this.getGroupPropertiesIterator(
      accessToken,
      iModelId,
      mappingId,
      groupId,
  ...
  public getGroupPropertiesIterator(
    ...
    const request = this.createRequest("GET", accessToken);
    return new EntityListIteratorImpl(async () =>
      getEntityCollectionPage<GroupProperty>(
        url,
        async (nextUrl: string): Promise<Collection<GroupProperty>> => {
          const response: GroupPropertyCollection =
            await this.fetchJSON<GroupPropertyCollection>(nextUrl, request);
          return {
  ...
  public async getGroupProperty(
    ...
    const requestOptions: RequestInit = this.createRequest("GET", accessToken);
    return (await this.fetchJSON<GroupPropertySingle>(url, requestOptions))
      .property;
  }
  ...
  public async createGroupProperty(
    ...
    if (
      groupProperty.ecProperties == null ||
      groupProperty.ecProperties.length === 0
    ) {
      throw new RequiredError(
        "ecProperties",
  ...
  public async getCalculatedProperties(
    ...
    const calculatedPropertyIterator = this.getCalculatedPropertiesIterator(
      accessToken,
      iModelId,
      mappingId,
      groupId,
  ...
  public getCalculatedPropertiesIterator(
    ...
    const request = this.createRequest("GET", accessToken);
    return new EntityListIteratorImpl(async () =>
      getEntityCollectionPage<CalculatedProperty>(
        url,
        async (nextUrl: string): Promise<Collection<CalculatedProperty>> => {
          const response: CalculatedPropertyCollection =
            await this.fetchJSON<CalculatedPropertyCollection>(
              nextUrl,
              request
            );
          return {
  ...
  public async getCalculatedProperty(
    ...
    const url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      ...
      groupId
    )}/calculatedProperties/${encodeURIComponent(propertyId)}`;
    const requestOptions: RequestInit = this.createRequest("GET", accessToken);
    return (await this.fetchJSON<CalculatedPropertySingle>(url, requestOptions))
      .property;
  }
  ...
  public async updateCalculatedProperty(
    ...
    if (
      ...
      !this.isSimpleIdentifier(property.propertyName)
    ) {
      throw new RequiredError(
        "propertyName",
        "Field propertyName was invalid."
    ...
    if (
      null != property.type &&
      property.type === CalculatedPropertyType.Undefined
    ) {
      throw new RequiredError(
        "type",
        "Required field type was null or undefined."
  ...
  public async getCustomCalculations(
    ...
    const customCalculationsIterator = this.getCustomCalculationsIterator(
      accessToken,
      iModelId,
      mappingId,
      groupId,
  ...
  public getCustomCalculationsIterator(
    ...
    const request = this.createRequest("GET", accessToken);
    return new EntityListIteratorImpl(async () =>
      getEntityCollectionPage<CustomCalculation>(
        url,
        async (nextUrl: string): Promise<Collection<CustomCalculation>> => {
          const response: CustomCalculationCollection =
            await this.fetchJSON<CustomCalculationCollection>(nextUrl, request);
          return {
  ...
  public async getCustomCalculation(
    ...
    const url = `${this.basePath}/datasources/imodels/${encodeURIComponent(
      ...
      groupId
    )}/customCalculations/${encodeURIComponent(propertyId)}`;
    const requestOptions: RequestInit = this.createRequest("GET", accessToken);
    return (await this.fetchJSON<CustomCalculationSingle>(url, requestOptions))
      .customCalculation;
  }
  ...
  public async updateCustomCalculation(
    ...
    if (
      null == property.formula &&
      null == property.propertyName &&
      null == property.quantityType
    ) {
      throw new RequiredError(
        "property",
        "All properties of property were missing."
  ...
  protected isValidECProperty(prop: ECProperty): boolean {
    return (
      !this.isNullOrWhitespace(prop.ecSchemaName) &&

 ...
 *--------------------------------------------------------------------------------------------*/
import { Briefcase, BriefcaseResponse } from "../../../../imodels-client-management/src/base";
import { BriefcaseOperations as ManagementBriefcaseOperations } from "../../../../imodels-client-management/src/IModelsClientExports"
